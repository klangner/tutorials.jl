...
url = "https://www.nasa.gov/sites/default/files/thumbnails/image/1_50750671133_187d4b303e_o.jpg" 
...
# ╔═╡ d06285f0-7369-11eb-35a6-9709387883e2
local_image = load("/Users/klangner/workspace/images/rover_drop.jpg")
...
# ╔═╡ 0ca6ee50-736c-11eb-18bc-1f3d2a2ae35b
md"Select RGB values:
	$(@bind r Slider(0:0.01:1))
	$(@bind g Slider(0:0.01:1))
	$(@bind b Slider(0:0.01:1))
"

# ╔═╡ 359eb5ae-736c-11eb-38be-fd25c59efe35
RGB(r, g, b)
